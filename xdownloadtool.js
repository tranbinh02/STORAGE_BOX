  ...
  return {
    ...
    addButtonTo: function (article) {
      ...
      if (media) {
        ...
        if (is_tweetdeck) {
          btn_down.firstElementChild.innerHTML = '<svg viewBox="0 0 24 24" style="width: 22px; height: 22px;">' + this.svg + '</svg>';
      ...
      if (imgs.length > 1) {
        ...
        imgs.forEach(img => {
          ...
          btn_down.innerHTML = '<div><div><svg viewBox="0 0 24 24" style="width: 22px; height: 22px;">' + this.svg + '</svg></div></div>';
...
.tmd-down:hover > div > div > div > div {color: #FFAF00}
.tmd-down:hover > div > div > div > div > div {background-color: rgba(29, 161, 242, 0.1);}
.tmd-down:active > div > div > div > div > div {background-color: rgba(29, 161, 242, 0.2);}
.tmd-down:hover svg {color: #FFAF00}
...
.tmd-down.tmd-media:hover > div > div {color: #FFAF00}
.tmd-down.tmd-media:not(:hover) > div > div {filter: drop-shadow(0 2px 5px rgb(0 0 0))!important}
.tmd-down g {display: none;}
.tmd-down.download g.download, .tmd-down.completed g.completed, .tmd-down.loading g.loading,.tmd-down.failed g.failed {display: unset;}
.tmd-down.loading svg {animation: spin 1s linear infinite;}
@keyframes spin {0% {transform: rotate(0deg);} 100% {transform: rotate(360deg);}}
.tmd-btn {display: inline-block; background-color: #FFAF00; color: #FFFFFF; padding: 0 20px; border-radius: 99px;}
.tmd-tag {display: inline-block; background-color: #FFFFFF; color: #FFAF00; padding: 0 10px; border-radius: 10px; border: 1px solid #FFAF00;  font-weight: bold; margin: 5px;}
...
.tmd-down.tmd-img:not(:hover) > div > div {filter: drop-shadow(0 2px 5px rgb(0 0 0))!important}
.tmd-down.tmd-img:hover > div > div {color: #FFAF00}
...
<g class="completed"><path d="M3,14 v5 q0,2 2,2 h14 q2,0 2,-2 v-5 M7,10 l3,4 q1,1 2,0 l8,-11" fill="none" stroke="#FFAF00" stroke-width="2" stroke-linecap="round" /></g>
<g class="loading"><circle cx="12" cy="12" r="10" fill="none" stroke="#FFAF00" stroke-width="4" opacity="0.4" /><path d="M12,2 a10,10 0 0 1 10,10" fill="none" stroke="#FFAF00" stroke-width="4" stroke-linecap="round" /></g>
